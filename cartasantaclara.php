...
<head>
    ...
    <title>Carta Santa Clara - Granja Azul</title>
</head>
<body>
    ...
    <section id="contenedor-tienda">
        ...
        <div id="grilla-productos">
            ...
            <div class="seccion-titulo" style="grid-column: 1 / -1;">LUNCH EJECUTIVO</div>

            <div class="producto-card" data-id="46" data-nombre="Lunch Ejecutivo 1" data-precio="59">
                <div class="producto-img-wrap"><img src="img/platos/lunch_ejecutivo1.jpg" alt="Lunch Ejecutivo 1"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Lunch Ejecutivo 1</span>
                    <span class="producto-precio">S/59</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>

            <div class="producto-card" data-id="47" data-nombre="Lunch Ejecutivo 2" data-precio="75">
                <div class="producto-img-wrap"><img src="img/platos/lunch_ejecutivo2.jpg" alt="Lunch Ejecutivo 2"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Lunch Ejecutivo 2</span>
                    <span class="producto-precio">S/75</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>
            ...
            <div class="producto-card" data-id="44" data-nombre="Crepe Suzette con Helado" data-precio="38">
                <div class="producto-img-wrap"><img src="img/platos/crepe_suzette_helado.jpg" alt="Crepe Suzette con Helado"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Crepe Suzette con Helado</span>
                    <span class="producto-precio">S/38</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>
            ...
            <div class="producto-card" data-id="45" data-nombre="Crepe con Manjar con Helado" data-precio="28">
                <div class="producto-img-wrap"><img src="img/platos/crepe_manjar_helado.jpg" alt="Crepe con Manjar con Helado"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Crepe con Manjar con Helado</span>
                    <span class="producto-precio">S/28</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>
            ...
            <div class="producto-card" data-id="37" data-nombre="Limonada Clasica" data-precio="10">
                <div class="producto-img-wrap"><img src="img/platos/vaso_limonda.jpg" alt="Limonada Clasica"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Limonada Clasica (vaso)</span>
                    <span class="producto-precio">S/10</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>

            <div class="producto-card" data-id="48" data-nombre="Limonada Clasica 1 Litro" data-precio="29">
                <div class="producto-img-wrap"><img src="img/platos/limonada_clasica.jpg" alt="Limonada Clasica 1 Litro"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Limonada Clasica (1 litro)</span>
            ...
            <div class="producto-card" data-id="38" data-nombre="Chicha Morada" data-precio="10">
                <div class="producto-img-wrap"><img src="img/platos/chicha_vaso.jpg" alt="Chicha Morada"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Chicha Morada (vaso)</span>
                    <span class="producto-precio">S/10</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>

            <div class="producto-card" data-id="49" data-nombre="Chicha Morada 1 Litro" data-precio="29">
                <div class="producto-img-wrap"><img src="img/platos/chicha_morada.jpg" alt="Chicha Morada 1 Litro"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Chicha Morada (1 litro)</span>
                    <span class="producto-precio">S/29</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>
            ...
            <div class="producto-card" data-id="50" data-nombre="Agua Mineral San Mateo" data-precio="8">
                <div class="producto-img-wrap"><img src="img/platos/agua_mineral.jpg" alt="Agua Mineral San Mateo"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Agua Mineral San Mateo</span>
                    <span class="producto-precio">S/8</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>

            <div class="producto-card" data-id="51" data-nombre="Agua San Luis" data-precio="7">
                <div class="producto-img-wrap"><img src="img/platos/agua_san_luis.jpg" alt="Agua San Luis"></div>
                <div class="producto-info">
                    <span class="producto-nombre">Agua San Luis</span>
                    <span class="producto-precio">S/7</span>
                </div>
                <button class="btn-agregar" onclick="agregarAlCarrito(this)">Agregar</button>
            </div>
